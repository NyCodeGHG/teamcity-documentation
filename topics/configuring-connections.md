...
An Amazon ECR (Elastic Container Registry) connection allows accessing private AWS registries. With its help, a [Docker Support](docker-support.md) build feature can store Docker images produced by a build to a private registry.
